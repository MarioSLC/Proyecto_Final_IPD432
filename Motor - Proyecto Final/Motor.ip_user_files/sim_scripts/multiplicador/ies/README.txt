...
#
# Generated by export_simulation on Wed May 23 04:47:08 -0400 2018
#
################################################################################
...
'-reset_run' switch to the './multiplicador.sh' script.

./multiplicador.sh -reset_run
...
./multiplicador.sh -noclean_files

For more information on the script, please type './multiplicador.sh -help'.
